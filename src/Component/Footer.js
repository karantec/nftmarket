    ...
    <footer className="bg-gray-200 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-24">
          ...
          <div>
            ...
            <div className="flex w-full max-w-md">
              ...
              />
              <button className="bg-black text-white px-4 py-2 rounded-r-md font-medium hover:bg-gray-800 transition">
                subscribe
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Link
                ...
                className="text-black text-3xl p-2 rounded-md hover:bg-gray-300 transition"
              >
                <MdOutlineEmail />
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="mailto:info@nywnft.com"
                className="bg-black px-6 py-3 rounded-md font-medium text-white text-center hover:bg-gray-800 transition"
              >
                Contact Support
              </Link>
              <Link
                to="/settings"
                className="bg-gray-900 text-white px-6 py-3 rounded-md hover:bg-black transition text-center"
              >
                Raise a ticket
              </Link>
            </div>
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 text-left">
          {/* NYWNFT */}
          <div>
            <Link to="/" className="text-lg font-semibold mb-3">
              NYWNFT
            </Link>
            <p className="text-sm">
              NYWNFT bridges Blockchain and AI, allowing you to own a piece of
              the action. Generate and mint NFTs easily.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm">
                Email:{" "}
                <a href="mailto:info@nywnft.com" className="hover:underline">
                  info@nywnft.com
                </a>
              </li>
              <li>
